...
elseif game.PlaceId == 258258996 then
  loadstring(game:HttpGet("https://raw.githubusercontent.com/vdjf68jbwz/scripts/refs/heads/main/minerhaven.lua"))()
end
